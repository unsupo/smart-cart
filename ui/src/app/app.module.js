...
var grafana_module_1 = require("../pages/Grafana/grafana.module");
var sda_installer_module_1 = require("../pages/sda-installer/sda-installer.module");
var login_module_1 = require("../pages/login/login.module");
var LoginService_1 = require("../utilities/LoginService");
...
AppModule = __decorate([
    core_1.NgModule({
        ...
        imports: [
            ...
            http_1.HttpModule,
            grafana_module_1.GrafanaPageModule,
            sda_installer_module_1.SdaInstallerPageModule,
